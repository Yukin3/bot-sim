...
export function LoginForm({ isSignUp, setIsSignUp, className, ...props }: LoginFormProps) {
    ...
    const handleAuth = async (e: React.FormEvent) => {
      ...
      try {
        const res = await fetch(`${API_URL}/auth/${endpoint}`, {
          ...
          body: JSON.stringify(
            isSignUp 
              ? { username, email, password }  //Sign-Up Payload
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
          {isSignUp ? "Sign up with Github or Google" : "Login with your Github or Google account"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleAuth}>
            <div className="grid gap-6">
              ...
              {/* Email + pw*/}
              <div className="grid gap-6">
                  {isSignUp && (  //render username input for signup
